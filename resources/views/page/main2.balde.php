            ...
            <div class="row py-md-5 text-center justify-content-center">
                <div class="col-md-12 col-lg-6 mb-6 mb-md-0">
                    <h1 class="display-2 fw-bold mb-4 position-relative home-title">
                        <span class="title1">Write</span> <br> 
                        <span class="title2">your thoughts down</span> <br>
                        <span class="title3">as they come to you</span>
                    </h1>
                    <p class="fs-4 mb-4">
                        Notes is a simple to use free note taking app made with Node.Js, EJS & MongoDB.
                    </p>
                    @auth
                    <a href="{{ route('notes.first') }}" class="btn btn-primary btn-lg">Try Notes, it's FREE!</a>
                    @else
                    <a href="{{ route('login') }}" class="btn btn-primary btn-lg">Try Notes, it's FREE!</a>
                    @endauth
                </div>
            </div>
        </main>
